...
<!--insert google map script-->
<script type="text/javascript"
src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
<script type="text/javascript" src="js/gmap3.min.js"></script>

<!--script gia facebook wall
...
jQuery(document).ready(function(){
	...
	if (lan=="GR"){
		...
		var contact_desc_greek="Φόρμα επικοινωνίας";
		var contact_txt_desc_greek="Εάν επιθυμείτε να επικοινωνήσετε μαζί μας συμπληρώστε τα απαιτουμενα πεδία";
	
		var name_txt_greek="Όνομα:";
		var email_txt_greek="Ηλεκτρονική διεύθυνση:";
		var contact_txt_greek="Επαφή No:";
		var message_txt_greek="Μήνυμα:";
		var submit_txt_greek="Αποστολή Μηνύματος";
		...
		$("#contact_desc").html(contact_desc_greek);
		$("#contact_txt_desc").html(contact_txt_desc_greek);

		$("#name_txt").html(name_txt_greek);
		$("#email_txt").html(email_txt_greek);	
		$("#contact_txt").html(contact_txt_greek);
		$("#message_txt").html(message_txt_greek);	
		$("#submit").val(submit_txt_greek);		
	}
		...
		var contact_desc_english="Contact Form";

		var contact_txt_desc_english="If you want us to contact you and send a message to us, please fill in the required fields";
		
		var name_txt_english="Name:";
		var email_txt_english="Email:";
		var contact_txt_english="Contact No:";
		var message_txt_english="Message:";
		var submit_txt_english="Send Message";
		...
		$("#contact_desc").html(contact_desc_english);	
		$("#contact_txt_desc").html(contact_txt_desc_english);
		$("#name_txt").html(name_txt_english);
		$("#email_txt").html(email_txt_english);		
		$("#contact_txt").html(contact_txt_english);	
		$("#message_txt").html(message_txt_english);	
		$("#submit").val(submit_txt_english);	
    ...
    });//end of button clik event
   //load google map
   //$("#map_canvas").gmap3();
//[35.338735200000000000, 25.144212599999946000]
$("#map_canvas").gmap3({
 map:{
    options:{
     center: [35.338735200000000000, 25.144212599999946000],
     zoom: 10
    }
 },
 marker:{
   latLng:[35.338735200000000000, 25.144212599999946000],
   address: "Heraklion,Crete"
 },
infowindow:{
     address:"Heraklion,Crete",
     options:{
       content: "Our address: Heraklion,Crete!"
     },
     events:{
...
//facebook wall connectivity

//telos facebook wall connectivity

</script>

<!--script gia contact form-->
...
?>
     <div class="container">
  		...
  		<div class="col-sm-6">
				...
				<h3><span id="contact_desc">Contact Form</span></h3>
				<h4><span id="contact_txt_desc">If you want us to contact you and send a message to us, 
				please fill in the required fields</span></h4>
				
				  <div class="form-group">
				    <label for="name"><span id="name_txt">Name: </span><span>*</span></label>
				    ...
				    <label for="contact"><span id="contact_txt">Contact No: </span><span>*</span></label>
				    <input type="text" class="form-control" id="contact" placeholder="10 digit Mobile no."/>
				    <label for="message"><span id="message_txt">Message: </span><span>*</span>:</label>
				    <textarea class="form-control" id="message" placeholder="Message......."></textarea>
				  </div>
				   <input type="button" id="submit" value="Send Message" class="btn btn-default"/>
			         </form>
				</div>
				<!--
				<div id="mainform">
					...
					<input type="text" id="email-contact" placeholder="Email"/>
	       ...
	       <div class="col-sm-6"> <!--google map-->
		<!--<section class="google-map"><div id="map_canvas">Map</div></section>-->
		<!--<section class="facebook-fan-page"><div id="facebook-fan-page">Facebook</div></section>-->
			<div class="container">
					...
					<section>
					<div id="page">
					  <div id="wall">Facebook Wall Fun Page
						<script id="headingTpl" type="text/x-jquery-tmpl">
							<h6>${name}<span> on Facebook</span></h6>
							</script>

							<script id="feedTpl" type="text/x-jquery-tmpl">
							<li>
							    <img src="${from.picture}" class="avatar img-responsive" />
							    
							    <div class="status">
								<h5><a href="http://www.facebook.com/profile.php?id=${from.id}" target="_blank">${from.name}</a></h5>
...
<script src="js/fbwall.js"></script>
